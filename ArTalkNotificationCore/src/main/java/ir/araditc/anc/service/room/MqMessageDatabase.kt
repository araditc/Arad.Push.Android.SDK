package ir.araditc.anc.service.room
...
import ir.araditc.anc.service.room.MqMessageDatabase.Companion.MQ_DB_VERSION
import ir.araditc.anc.service.room.entity.MqMessageEntity
    ...
    companion object {
        ...
        private fun buildDatabase(context: Context, storageName: String): MqMessageDatabase {
            return Room.databaseBuilder(
                context.applicationContext, MqMessageDatabase::class.java, storageName
            ).build()
        }
    }
}
