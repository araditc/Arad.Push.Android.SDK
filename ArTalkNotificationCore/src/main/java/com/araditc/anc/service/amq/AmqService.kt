...
import com.araditc.anc.service.amq.room.AmqMessageDatabase
 ...
 * [ MqttServiceConstants.CALLBACK_TO_ACTIVITY][AmqServiceConstants.CALLBACK_TO_ACTIVITY] which allows the Activity to
 ...
 * [ MqttServiceConstants.CALLBACK_CLIENT_HANDLE][AmqServiceConstants.CALLBACK_CLIENT_HANDLE]</td>
 ...
 * <tr>
 * <td align="left" valign="top">[ MqttServiceConstants.CALLBACK_STATUS][AmqServiceConstants.CALLBACK_STATUS]</td>
 ...
 * <tr>
 * <td align="left" valign="top">
 * [ MqttServiceConstants.CALLBACK_ACTIVITY_TOKEN][AmqServiceConstants.CALLBACK_ACTIVITY_TOKEN]</td>
 * <td align="left" valign="top">String</td>
 ...
 * <tr>
 * <td align="left" valign="top">
 * [ MqttServiceConstants.CALLBACK_INVOCATION_CONTEXT][AmqServiceConstants.CALLBACK_INVOCATION_CONTEXT]</td>
 * <td align="left" valign="top">String</td>
 ...
 * <tr>
 * <td align="left" valign="top">[ MqttServiceConstants.CALLBACK_ACTION][AmqServiceConstants.CALLBACK_ACTION]</td>
 * <td align="left" valign="top">String</td>
 * <td align="left" valign="top">one of
 * <table summary="">
 * <tr>
 * <td align="left" valign="top"> [ MqttServiceConstants.SEND_ACTION][AmqServiceConstants.SEND_ACTION]</td>
</tr> *
 * <tr>
 * <td align="left" valign="top">
 * [ MqttServiceConstants.UNSUBSCRIBE_ACTION][AmqServiceConstants.UNSUBSCRIBE_ACTION]</td>
</tr> *
 * <tr>
 * <td align="left" valign="top"> [ MqttServiceConstants.SUBSCRIBE_ACTION][AmqServiceConstants.SUBSCRIBE_ACTION]</td>
</tr> *
 * <tr>
 * <td align="left" valign="top"> [ MqttServiceConstants.DISCONNECT_ACTION][AmqServiceConstants.DISCONNECT_ACTION]</td>
</tr> *
 * <tr>
 * <td align="left" valign="top"> [ MqttServiceConstants.CONNECT_ACTION][AmqServiceConstants.CONNECT_ACTION]</td>
</tr> *
 * <tr>
 * <td align="left" valign="top">
 * [ MqttServiceConstants.MESSAGE_ARRIVED_ACTION][AmqServiceConstants.MESSAGE_ARRIVED_ACTION]</td>
</tr> *
 * <tr>
 * <td align="left" valign="top">
 * [ MqttServiceConstants.MESSAGE_DELIVERED_ACTION][AmqServiceConstants.MESSAGE_DELIVERED_ACTION]</td>
</tr> *
 * <tr>
 * <td align="left" valign="top">
 * [ MqttServiceConstants.ON_CONNECTION_LOST_ACTION][AmqServiceConstants.ON_CONNECTION_LOST_ACTION]</td>
</tr> *
</table> *
</td> *
 * <td align="left" valign="top">All operations</td>
 ...
 * <tr>
 * <td align="left" valign="top">
 * [ MqttServiceConstants.CALLBACK_ERROR_MESSAGE][AmqServiceConstants.CALLBACK_ERROR_MESSAGE]
 ...
 * <tr>
 * <td align="left" valign="top">
 * [ MqttServiceConstants.CALLBACK_ERROR_NUMBER][AmqServiceConstants.CALLBACK_ERROR_NUMBER]
 ...
 * <tr>
 * <td align="left" valign="top">
 * [ MqttServiceConstants.CALLBACK_EXCEPTION_STACK][AmqServiceConstants.CALLBACK_EXCEPTION_STACK]</td>
 * <td align="left" valign="top">String</td>
 ...
 * <tr>
 * <td align="left" valign="top">
 * [ MqttServiceConstants.CALLBACK_MESSAGE_ID][AmqServiceConstants.CALLBACK_MESSAGE_ID]</td>
 * <td align="left" valign="top">String</td>
 ...
 * <tr>
 * <td align="left" valign="top">
 * [ MqttServiceConstants.CALLBACK_DESTINATION_NAME][AmqServiceConstants.CALLBACK_DESTINATION_NAME]
</td> * <td align="left" valign="top">String</td>
 ...
 * <tr>
 * <td align="left" valign="top">
 * [ MqttServiceConstants.CALLBACK_MESSAGE_PARCEL][AmqServiceConstants.CALLBACK_MESSAGE_PARCEL]</td>
...
class AmqService : Service(), AmqTraceHandler {
    private val TAG = "APN"

    // mapping from client handle strings to actual client connections.
    internal val connections: MutableMap<String, AmqConnection> = ConcurrentHashMap()

    // somewhere to persist received messages until we're sure that they've reached the application
    lateinit var messageDatabase: AmqMessageDatabase
    ...
    private var amqServiceBinder: AmqServiceBinder? = null
    ...
    override fun onBind(intent: Intent): IBinder? {
        ...
        val activityToken = intent.getStringExtra(AmqServiceConstants.CALLBACK_ACTIVITY_TOKEN)
        amqServiceBinder!!.activityToken = activityToken
        return amqServiceBinder
    }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val foregroundServiceNotification = intent?.getParcelableExtra<Notification>(
                MQTT_FOREGROUND_SERVICE_NOTIFICATION
            )
    ...
    fun callbackToActivity(clientHandle: String, status: Status, dataBundle: Bundle) {
        ...
        bundle.putString(AmqServiceConstants.CALLBACK_CLIENT_HANDLE, clientHandle)
        bundle.putSerializable(AmqServiceConstants.CALLBACK_STATUS, status)
        serviceScope?.launch {
            flow.emit(bundle)
        }
    }
    ...
    fun getClient(
        ...
        if (!connections.containsKey(clientHandle)) {
            val client = AmqConnection(this, serverURI, clientId, persistence, clientHandle)
    ...
    fun publish(
        ...
        return getConnection(clientHandle).publish(
            topic, payload, qos, retained, invocationContext, activityToken!!
        )
    }
    ...
    fun subscribe(
        ...
        getConnection(clientHandle).subscribe(
            topicFilters, qos, invocationContext, activityToken!!, messageListeners
        )
    }
     ...
     */
    fun unsubscribe(
        clientHandle: String, topic: String, invocationContext: String?, activityToken: String
    ) {
     ...
     */
    private fun getConnection(clientHandle: String): AmqConnection {
        return connections[clientHandle]
            ?: throw IllegalArgumentException("Invalid ClientHandle >$clientHandle<")
    }
    ...
    override fun traceDebug(message: String?) {
        traceCallback(AmqServiceConstants.TRACE_DEBUG, message)
    }
    ...
    override fun traceError(message: String?) {
        traceCallback(AmqServiceConstants.TRACE_ERROR, message)
    }
        ...
        traceCallbackId?.let {
            if (isTraceEnabled) {
                ...
                dataBundle.putString(
                    AmqServiceConstants.CALLBACK_ACTION, AmqServiceConstants.TRACE_ACTION
                )
                dataBundle.putString(AmqServiceConstants.CALLBACK_TRACE_SEVERITY, severity)
                dataBundle.putString(AmqServiceConstants.CALLBACK_ERROR_MESSAGE, message)
    ...
    override fun traceException(message: String?, e: Exception?) {
        traceCallbackId?.let {
            ...
            dataBundle.putString(
                AmqServiceConstants.CALLBACK_TRACE_SEVERITY, AmqServiceConstants.TRACE_EXCEPTION
            )
            dataBundle.putString(AmqServiceConstants.CALLBACK_ERROR_MESSAGE, message)
            dataBundle.putSerializable(AmqServiceConstants.CALLBACK_EXCEPTION, e)
            callbackToActivity(it, Status.ERROR, dataBundle)
        }
    }
    ...
    private fun registerBroadcastReceivers() {
        if (networkConnectionMonitor == null) {
            ...
            registerReceiver(
                networkConnectionMonitor, IntentFilter(ConnectivityManager.CONNECTIVITY_ACTION)
            )
        }
    }
    ...
    fun getBufferedMessageCount(clientHandle: String) =
        getConnection(clientHandle).bufferedMessageCount
    ...
    fun getInFlightMessageCount(clientHandle: String) =
        getConnection(clientHandle).inFlightMessageCount
    ...
    companion object {
        val MQTT_FOREGROUND_SERVICE_NOTIFICATION_ID =
            AmqService::class.java.simpleName + ".FOREGROUND_SERVICE_NOTIFICATION_ID"
        val MQTT_FOREGROUND_SERVICE_NOTIFICATION =
            AmqService::class.java.simpleName + ".FOREGROUND_SERVICE_NOTIFICATION"
    }
}
